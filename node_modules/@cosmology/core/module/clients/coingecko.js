...
export const getPrices = async (coins = ['osmosis']) => {
  ...
  try {
    ...
    console.error('CoinGecko API response error:', e.response ? e.response.data : e);
    return null;
  }
};
...
export const _getPricesFromCoinGecko = async () => {
  ...
  const geckoIds = geckoAssets.map(asset => asset.coingecko_id);
