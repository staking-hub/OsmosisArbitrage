...
var QueryClientImpl = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(QueryClientImpl, [{
    ...
    key: "poolsWithFilter",
    value: function poolsWithFilter(request) {
      var data = _query.QueryPoolsWithFilterRequest.encode(request).finish();
      var promise = this.rpc.request("osmosis.gamm.v1beta1.Query", "PoolsWithFilter", data);
      return promise.then(function (data) {
        return _query.QueryPoolsWithFilterResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
    key: "pool",
    ...
    key: "calcJoinPoolNoSwapShares",
    value: function calcJoinPoolNoSwapShares(request) {
      var data = _query.QueryCalcJoinPoolNoSwapSharesRequest.encode(request).finish();
      var promise = this.rpc.request("osmosis.gamm.v1beta1.Query", "CalcJoinPoolNoSwapShares", data);
      return promise.then(function (data) {
        return _query.QueryCalcJoinPoolNoSwapSharesResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
    key: "calcJoinPoolShares",
    value: function calcJoinPoolShares(request) {
      var data = _query.QueryCalcJoinPoolSharesRequest.encode(request).finish();
      var promise = this.rpc.request("osmosis.gamm.v1beta1.Query", "CalcJoinPoolShares", data);
      return promise.then(function (data) {
        return _query.QueryCalcJoinPoolSharesResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
    key: "calcExitPoolCoinsFromShares",
    value: function calcExitPoolCoinsFromShares(request) {
      var data = _query.QueryCalcExitPoolCoinsFromSharesRequest.encode(request).finish();
      var promise = this.rpc.request("osmosis.gamm.v1beta1.Query", "CalcExitPoolCoinsFromShares", data);
      return promise.then(function (data) {
        return _query.QueryCalcExitPoolCoinsFromSharesResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
    key: "poolParams",
...
var createRpcQueryExtension = function createRpcQueryExtension(base) {
  ...
  return {
    ...
    poolsWithFilter: function poolsWithFilter(request) {
    ...
    calcJoinPoolNoSwapShares: function calcJoinPoolNoSwapShares(request) {
      return queryService.calcJoinPoolNoSwapShares(request);
    },
    calcJoinPoolShares: function calcJoinPoolShares(request) {
      return queryService.calcJoinPoolShares(request);
    },
    calcExitPoolCoinsFromShares: function calcExitPoolCoinsFromShares(request) {
