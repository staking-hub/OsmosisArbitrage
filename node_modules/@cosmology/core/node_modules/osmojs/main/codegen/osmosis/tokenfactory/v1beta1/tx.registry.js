...
var MessageComposer = {
  encoded: {
    ...
    setBeforeSendHook: function setBeforeSendHook(value) {
      return {
        typeUrl: "/osmosis.tokenfactory.v1beta1.MsgSetBeforeSendHook",
        value: _tx.MsgSetBeforeSendHook.encode(value).finish()
      };
    },
  ...
  fromPartial: {
    ...
    setBeforeSendHook: function setBeforeSendHook(value) {
      return {
        typeUrl: "/osmosis.tokenfactory.v1beta1.MsgSetBeforeSendHook",
        value: _tx.MsgSetBeforeSendHook.fromPartial(value)
      };
    },
    forceTransfer: function forceTransfer(value) {
      return {
