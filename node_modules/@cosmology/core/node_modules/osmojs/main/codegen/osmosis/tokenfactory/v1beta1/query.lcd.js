...
var LCDQueryClient = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(LCDQueryClient, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                endpoint = "osmosis/tokenfactory/v1beta1/params";
                _context.next = 4;
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                endpoint = "osmosis/tokenfactory/v1beta1/denoms/".concat(params.denom, "/authority_metadata");
                _context2.next = 3;
                return this.req.get(endpoint);
              case 3:
        ...
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                endpoint = "osmosis/tokenfactory/v1beta1/denoms_from_creator/".concat(params.creator);
                _context3.next = 3;
                return this.req.get(endpoint);
              case 3:
    ...
    key: "beforeSendHookAddress",
    value: function () {
      var _beforeSendHookAddress = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(params) {
        var endpoint;
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                endpoint = "osmosis/tokenfactory/v1beta1/denoms/".concat(params.denom, "/before_send_hook");
                _context4.next = 3;
                return this.req.get(endpoint);
              case 3:
      ...
      function beforeSendHookAddress(_x3) {
        return _beforeSendHookAddress.apply(this, arguments);
      }
      return beforeSendHookAddress;
    }()
  }]);
