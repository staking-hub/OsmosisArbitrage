...
var ReplaceMigrationRecordsProposal = {
  ...
  encode: function encode(message) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var v = _step.value;
        _genesis.BalancerToConcentratedPoolLink.encode(v, writer.uint32(26).fork()).ldelim();
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
  ...
  decode: function decode(input, length) {
    ...
    var message = createBaseReplaceMigrationRecordsProposal();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.records.push(_genesis.BalancerToConcentratedPoolLink.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.records = ((_object$records = object.records) === null || _object$records === void 0 ? void 0 : _object$records.map(function (e) {
      return _genesis.BalancerToConcentratedPoolLink.fromPartial(e);
    })) || [];
    return message;
  },
  fromAmino: function fromAmino(object) {
    return {
      ...
      records: Array.isArray(object === null || object === void 0 ? void 0 : object.records) ? object.records.map(function (e) {
        return _genesis.BalancerToConcentratedPoolLink.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.records) {
      obj.records = message.records.map(function (e) {
        return e ? _genesis.BalancerToConcentratedPoolLink.toAmino(e) : undefined;
      });
    } else {
      obj.records = [];
    }
...
exports.ReplaceMigrationRecordsProposal = ReplaceMigrationRecordsProposal;
...
var UpdateMigrationRecordsProposal = {
  ...
  decode: function decode(input, length) {
    var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    var end = length === undefined ? reader.len : reader.pos + length;
    var message = createBaseUpdateMigrationRecordsProposal();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
exports.UpdateMigrationRecordsProposal = UpdateMigrationRecordsProposal;