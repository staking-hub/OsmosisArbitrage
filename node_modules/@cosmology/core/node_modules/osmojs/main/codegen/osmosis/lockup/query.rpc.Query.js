...
var QueryClientImpl = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(QueryClientImpl, [{
    ...
    key: "nextLockID",
    value: function nextLockID() {
      var request = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var data = _query.NextLockIDRequest.encode(request).finish();
      var promise = this.rpc.request("osmosis.lockup.Query", "NextLockID", data);
      return promise.then(function (data) {
        return _query.NextLockIDResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
...
var createRpcQueryExtension = function createRpcQueryExtension(base) {
  ...
  return {
    ...
    nextLockID: function nextLockID(request) {
