        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                endpoint = "cosmwasm/wasm/v1/contract/".concat(params.address, "/raw/").concat(params.queryData);
                _context5.next = 3;
                return this.req.get(endpoint);
              case 3:
        ...
        return _regenerator["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                endpoint = "cosmwasm/wasm/v1/contract/".concat(params.address, "/smart/").concat(params.queryData);
                _context6.next = 3;
                return this.req.get(endpoint);
              case 3:
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                endpoint = "cosmwasm/wasm/v1/contracts/creator/".concat(params.creatorAddress);
                _context11.next = 5;
                return this.req.get(endpoint, options);
              case 5:
