...
var Params = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      allowMessages: Array.isArray(object === null || object === void 0 ? void 0 : object.allow_messages) ? object.allow_messages.map(function (e) {
        return e;
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.allowMessages) {
      obj.allow_messages = message.allowMessages.map(function (e) {
        return e;
      });
    } else {
      obj.allow_messages = [];
