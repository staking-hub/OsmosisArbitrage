...
var QueryClientImpl = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(QueryClientImpl, [{
    ...
    key: "totalSupplyWithoutOffset",
    value: function totalSupplyWithoutOffset() {
      var request = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
        pagination: undefined
      };
      var data = _query.QueryTotalSupplyWithoutOffsetRequest.encode(request).finish();
      var promise = this.rpc.request("cosmos.bank.v1beta1.Query", "TotalSupplyWithoutOffset", data);
      return promise.then(function (data) {
        return _query.QueryTotalSupplyWithoutOffsetResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
    key: "supplyOfWithoutOffset",
    value: function supplyOfWithoutOffset(request) {
      var data = _query.QuerySupplyOfWithoutOffsetRequest.encode(request).finish();
      var promise = this.rpc.request("cosmos.bank.v1beta1.Query", "SupplyOfWithoutOffset", data);
      return promise.then(function (data) {
        return _query.QuerySupplyOfWithoutOffsetResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
    key: "params",
    ...
    value: function baseDenom(request) {
      ...
      var promise = this.rpc.request("cosmos.bank.v1beta1.Query", "BaseDenom", data);
      return promise.then(function (data) {
...
var createRpcQueryExtension = function createRpcQueryExtension(base) {
  ...
  return {
    ...
    totalSupplyWithoutOffset: function totalSupplyWithoutOffset(request) {
      return queryService.totalSupplyWithoutOffset(request);
    },
    supplyOfWithoutOffset: function supplyOfWithoutOffset(request) {
    ...
    baseDenom: function baseDenom(request) {
