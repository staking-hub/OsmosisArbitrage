...
var AccumulatorContent = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      accumValue: Array.isArray(object === null || object === void 0 ? void 0 : object.accum_value) ? object.accum_value.map(function (e) {
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.accumValue) {
      obj.accum_value = message.accumValue.map(function (e) {
...
var Record = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      initAccumValue: Array.isArray(object === null || object === void 0 ? void 0 : object.init_accum_value) ? object.init_accum_value.map(function (e) {
        return _coin.DecCoin.fromAmino(e);
      }) : [],
      unclaimedRewards: Array.isArray(object === null || object === void 0 ? void 0 : object.unclaimed_rewards) ? object.unclaimed_rewards.map(function (e) {
        return _coin.DecCoin.fromAmino(e);
      }) : [],
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.initAccumValue) {
      obj.init_accum_value = message.initAccumValue.map(function (e) {
        return e ? _coin.DecCoin.toAmino(e) : undefined;
      });
    } else {
    ...
    if (message.unclaimedRewards) {
      obj.unclaimed_rewards = message.unclaimedRewards.map(function (e) {
        return e ? _coin.DecCoin.toAmino(e) : undefined;
      });
    } else {
