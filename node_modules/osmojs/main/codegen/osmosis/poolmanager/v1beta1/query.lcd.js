...
var LCDQueryClient = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(LCDQueryClient, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                endpoint = "osmosis/poolmanager/v1beta1/".concat(params.poolId, "/estimate/swap_exact_amount_in");
                _context2.next = 6;
    ...
    value: function () {
      var _estimateSinglePoolSwapExactAmountIn = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(params) {
        var options, endpoint;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                endpoint = "osmosis/poolmanager/v1beta1/".concat(params.poolId, "/estimate/single_pool_swap_exact_amount_in");
                _context3.next = 6;
                return this.req.get(endpoint, options);
              case 6:
      ...
      function estimateSinglePoolSwapExactAmountIn(_x2) {
        return _estimateSinglePoolSwapExactAmountIn.apply(this, arguments);
      }
      return estimateSinglePoolSwapExactAmountIn;
    }() /* Estimates swap amount in given out. */
  }, {
    key: "estimateSwapExactAmountOut",
    value: function () {
      var _estimateSwapExactAmountOut = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(params) {
        var options, endpoint;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                endpoint = "osmosis/poolmanager/v1beta1/".concat(params.poolId, "/estimate/swap_exact_amount_out");
                _context4.next = 6;
                return this.req.get(endpoint, options);
              case 6:
      ...
      function estimateSwapExactAmountOut(_x3) {
    ...
    value: function () {
      var _estimateSinglePoolSwapExactAmountOut = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(params) {
        var options, endpoint;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                endpoint = "osmosis/poolmanager/v1beta1/".concat(params.poolId, "/estimate_out/single_pool_swap_exact_amount_out");
                _context5.next = 6;
                return this.req.get(endpoint, options);
              case 6:
      ...
      function estimateSinglePoolSwapExactAmountOut(_x4) {
        return _estimateSinglePoolSwapExactAmountOut.apply(this, arguments);
      }
      return estimateSinglePoolSwapExactAmountOut;
    }() /* Returns the total number of pools existing in Osmosis. */
  }, {
    key: "numPools",
    value: function () {
      var _numPools = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6() {
        var _params,
          endpoint,
          _args6 = arguments;
    ...
    key: "pool",
    value: function () {
      var _pool = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(params) {
        var endpoint;
        return _regenerator["default"].wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                endpoint = "osmosis/poolmanager/v1beta1/pools/".concat(params.poolId);
                _context7.next = 3;
                return this.req.get(endpoint);
              case 3:
    ...
    key: "allPools",
    value: function () {
      var _allPools = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(params) {
        var options, endpoint;
      ...
      function allPools(_x6) {
        return _allPools.apply(this, arguments);
      }
      return allPools;
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                endpoint = "osmosis/poolmanager/pools/".concat(params.poolId, "/prices");
                _context9.next = 6;
                return this.req.get(endpoint, options);
              case 6:
