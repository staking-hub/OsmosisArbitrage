...
var EpochInfo = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      currentEpochStartTime: object !== null && object !== void 0 && object.current_epoch_start_time ? _timestamp.Timestamp.fromAmino(object.current_epoch_start_time) : undefined,
      epochCountingStarted: object.epoch_counting_started,
      currentEpochStartHeight: _helpers.Long.fromString(object.current_epoch_start_height)
    };
  },
  toAmino: function toAmino(message) {
    ...
    obj.current_epoch_start_time = message.currentEpochStartTime ? _timestamp.Timestamp.toAmino(message.currentEpochStartTime) : undefined;
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.epochs) {
      obj.epochs = message.epochs.map(function (e) {
        return e ? EpochInfo.toAmino(e) : undefined;
      });
    } else {
      obj.epochs = [];
    }
