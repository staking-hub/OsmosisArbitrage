...
var QueryClientImpl = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(QueryClientImpl, [{
    ...
    value: function allIntermediaryAccounts() {
      var request = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    ...
    key: "totalDelegationByValidatorForDenom",
    value: function totalDelegationByValidatorForDenom(request) {
      var data = _query.QueryTotalDelegationByValidatorForDenomRequest.encode(request).finish();
      var promise = this.rpc.request("osmosis.superfluid.Query", "TotalDelegationByValidatorForDenom", data);
      return promise.then(function (data) {
        return _query.QueryTotalDelegationByValidatorForDenomResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
    key: "totalSuperfluidDelegations",
    value: function totalSuperfluidDelegations() {
      var request = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    value: function totalDelegationByDelegator(request) {
      var data = _query.QueryTotalDelegationByDelegatorRequest.encode(request).finish();
      var promise = this.rpc.request("osmosis.superfluid.Query", "TotalDelegationByDelegator", data);
      return promise.then(function (data) {
        return _query.QueryTotalDelegationByDelegatorResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
    key: "unpoolWhitelist",
    value: function unpoolWhitelist() {
      var request = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var data = _query.QueryUnpoolWhitelistRequest.encode(request).finish();
      var promise = this.rpc.request("osmosis.superfluid.Query", "UnpoolWhitelist", data);
      return promise.then(function (data) {
        return _query.QueryUnpoolWhitelistResponse.decode(new _m0.Reader(data));
      });
    }
  }]);
...
var createRpcQueryExtension = function createRpcQueryExtension(base) {
  ...
  return {
    ...
    assetType: function assetType(request) {
      return queryService.assetType(request);
    },
    allAssets: function allAssets(request) {
      return queryService.allAssets(request);
    },
    assetMultiplier: function assetMultiplier(request) {
      return queryService.assetMultiplier(request);
    },
    allIntermediaryAccounts: function allIntermediaryAccounts(request) {
      return queryService.allIntermediaryAccounts(request);
    },
    connectedIntermediaryAccount: function connectedIntermediaryAccount(request) {
      return queryService.connectedIntermediaryAccount(request);
    },
    totalDelegationByValidatorForDenom: function totalDelegationByValidatorForDenom(request) {
      return queryService.totalDelegationByValidatorForDenom(request);
    },
    totalSuperfluidDelegations: function totalSuperfluidDelegations(request) {
      return queryService.totalSuperfluidDelegations(request);
    },
    superfluidDelegationAmount: function superfluidDelegationAmount(request) {
      return queryService.superfluidDelegationAmount(request);
    },
    superfluidDelegationsByDelegator: function superfluidDelegationsByDelegator(request) {
      return queryService.superfluidDelegationsByDelegator(request);
    },
    superfluidUndelegationsByDelegator: function superfluidUndelegationsByDelegator(request) {
      return queryService.superfluidUndelegationsByDelegator(request);
    },
    superfluidDelegationsByValidatorDenom: function superfluidDelegationsByValidatorDenom(request) {
      return queryService.superfluidDelegationsByValidatorDenom(request);
    },
    estimateSuperfluidDelegatedAmountByValidatorDenom: function estimateSuperfluidDelegatedAmountByValidatorDenom(request) {
      return queryService.estimateSuperfluidDelegatedAmountByValidatorDenom(request);
    },
    totalDelegationByDelegator: function totalDelegationByDelegator(request) {
      return queryService.totalDelegationByDelegator(request);
    },
    unpoolWhitelist: function unpoolWhitelist(request) {
