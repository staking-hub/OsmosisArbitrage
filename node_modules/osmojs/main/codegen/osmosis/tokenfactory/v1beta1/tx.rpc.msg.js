...
var MsgClientImpl = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(MsgClientImpl, [{
    ...
    key: "setBeforeSendHook",
    value: function setBeforeSendHook(request) {
      var data = _tx.MsgSetBeforeSendHook.encode(request).finish();
      var promise = this.rpc.request("osmosis.tokenfactory.v1beta1.Msg", "SetBeforeSendHook", data);
      return promise.then(function (data) {
        return _tx.MsgSetBeforeSendHookResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
    key: "forceTransfer",
